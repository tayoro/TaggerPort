...
export default function FormImagePortfolio({openModal, isUpdate, onClose, image}: ModalType) {
    ...
    const {portfolios, addImagePortfolio} = useFireBasePortfolio()
                ...
                for (let i = 0; i < fileImages.length; i++) {
                    ...
                    uploadTask.on(
                        ...
                        async() => {
                            ...
                            addImagePortfolio({...formData, image: imageUrl, numero: i, titre: image.titre, desc: image.desc })
                        }
                    );  
                } 
                ...
                <div className="absolute top-0 left-0 z-40 grid h-screen w-full place-items-center backdrop-blur">
                    <div className="max-x-[700px] relative z-50 m-auto min-h-[200px] bg-white p-4 shadow-lg border border-gray-800 rounded-md w-[450px]">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-1">
                                ...
                                <label className="hidden" htmlFor="titre">Titre</label>
                                <input defaultValue="a" {...register("titre")} id="titre" className="border border-gray-300 p-2 rounded-md hidden"/>
                                ...
                                <label className="hidden" htmlFor="desc">Description</label>
                                <textarea  {...register("desc")} id="desc" rows="5" placeholder="Petite description de la video...." className="border border-gray-300 p-2 rounded-md hidden"> b </textarea>
