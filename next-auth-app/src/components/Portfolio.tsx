...
export default function Portfolio({portfolio} : {portfolio: DataPortfolioType}) {
    ...
    <>  
        ...
        <div className= {`${styles.portfolio} relative my-[20px] w-[300px] h-[270px] mx-[5px] rounded-t-lg xl:w-[250px]  transition-timing-function: cubic-bezier(0, 0, 0.2, 1) overflow-hidden `}>
            <div className='absolute top-3 left-3'>
                <span className='bg-white rounded-[50%] p-2 w-10 h-10 flex items-center justify-center'>{listeElementSelectionner.length}</span>
            </div>
